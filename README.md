...
[![Phase 3](https://img.shields.io/badge/Phase%203-NTHU%20Taiwan-red)](#)
...
- Advanced semiconductor device fabrication & characterization

together providing a comprehensive understanding of modern nanotechnology and semiconductor engineering.

---

## 📑 Table of Contents

- [Phase 2 — IIT Hyderabad Cleanroom Training](#phase-2--iit-hyderabad-cleanroom-training)
  - [Techniques Learned](#techniques-learned)
  - [Module 1 — MoS₂ Nanomaterial Synthesis & Characterization](#module-1--mos-nanomaterial-synthesis--characterization)
  - [Module 2 — SnS₂ Chemiresistive Gas Sensor](#module-2--sns-chemiresistive-gas-sensor)
- [Phase 3 — International Research Visit (NTHU, Taiwan)](#phase-3--international-research-visit-nthu-taiwan)
  - [End-to-End Semiconductor Fabrication](#1-end-to-end-semiconductor-fabrication)
  - [Device Characterization (Electrical)](#2-device-characterization-electrical)
  - [MEMS Fabrication (Silicon Cantilever)](#3-mems-fabrication-silicon-cantilever)
  - [MEMS Characterization](#mems-characterization)
  - [Phase 3 Outcome](#phase-3-outcome)
- [Summary](#-summary)
- [Acknowledgment](#-acknowledgment)

---

## 🧪 Phase 2 — IIT Hyderabad Cleanroom Training
...
**Objective:** To synthesize and analyze the growth characteristics of molybdenum disulfide (MoS₂) nanomaterials.

**Fabrication Workflow**
1. Substrate preparation
2. Lithographic patterning
3. Metal deposition via sputtering
4. Growth using Chemical Vapor Deposition (CVD)
...
**Objective:** To design, fabricate, and evaluate a chemiresistive gas sensor using tin disulfide (SnS₂).
...
- I<sub>D</sub>–V<sub>D</sub> (output characteristics)
- I<sub>D</sub>–V<sub>G</sub> (transfer characteristics)
- Extraction of:
...
- I<sub>C</sub>–V<sub>CE</sub> and I<sub>C</sub>–V<sub>BE</sub> analysis
...
1. Si₃N₄ thin film deposition (PVD)
2. Photolithographic patterning
3. Anisotropic dry etching (nitride patterning)
4. Isotropic silicon etching (device release)
5. Photoresist stripping

> **Key Insight:** The isotropic silicon undercut step is critical for transforming a patterned structure into a mechanically active suspended device.
...
| Technique | Purpose |
|-----------|---------|
| **RF Characterization** (VNA + Probe) | Extraction of resonant frequency and Q-factor |
| **White Light Interferometry (WLI)** | Nanometer-scale surface height measurement |
| **Laser Doppler Vibrometry (LDV)** | Measurement of vibration modes and dynamic response |
| **Confocal Microscopy** | 3D surface profiling and defect inspection |
| **Digital Holographic Microscopy (DHM)** | Real-time full-field 3D phase imaging; dynamic deformation analysis |

> **Key Learning:** No single technique is sufficient — multi-instrument characterization is essential to fully evaluate MEMS device performance.
